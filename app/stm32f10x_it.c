...
#define TIM_SR_CC1OF ((u16)0x200)
#define TIM_SR_CC2OF ((u16)0x400)
...
extern UART_DATA_T g_UART_USB;
void USART1_IRQHandler(void)
{
  uint8_t bytes, databyte;
  
  if (USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)
  {
    USART_ClearITPendingBit(USART1, USART_IT_RXNE);
    databyte = USART_ReceiveData(USART1);
    RingBuffer_Insert(&g_UART_USB.rxBuf, &databyte);
  }
}
